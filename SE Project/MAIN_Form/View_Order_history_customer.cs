...
namespace MAIN_Form
{
    public partial class View_Order_history_customer : Form
    {
        ...
        private void Load_curr()
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from Orders where Order_Status = 'Completed' and Customer_ID='" + idcust + "'", con); //creating command here
        ...
        public View_Order_history_customer()
        {
            InitializeComponent();
        }
        ...
        private void View_Order_history_customer_Load(object sender, EventArgs e)
        {
            Find_idLogin();
            Find_Cust_Name();
            Load_curr();
